            ...
            <div className="mb-32 mt-6 lg:-mt-12 lg:mx-auto p-6 lg:p-12 bg-gray-100 rounded-xl">
                <article className="prose prose-sm">
                    ...
                    <div className="">
                        ...
                        <p>Fabian Hurnaus<br/> Diendorf 2<br/> 4153 Peilstein im Mühlviertel</p>

                        <h2 className="is-size-3">Kontakt:</h2>
                        <p>Kontakt via <a href="https://fahu.at/contact">Kontaktformular</a></p>

                        <h2 className="is-size-3">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h2>
                        <p>Fabian Hurnaus<br/> Diendorf 2<br/> 4153 Peilstein im Mühlviertel</p>

                        <h2 className="is-size-3">Haftung für Inhalte</h2>
                        <p>Als Diensteanbieter sind wir gemäß § 7 Abs.1

                            TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach
                            §§ 8
                            bis
                        ...
                        <h2 className="is-size-3">Haftung für Links</h2>
                        <p>Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen
                            Einfluss
                            haben. Deshalb können
                            wir für diese fremden Inhalte auch keine Gewähr übernehmen. Für die Inhalte der verlinkten
                        ...
                        <p>Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch ohne konkrete
                            ...
                            Links umgehend
                            entfernen.</p>
                        <h2 className="is-size-3">Urheberrecht</h2>
